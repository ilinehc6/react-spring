...
import {AddEmployee as createEmployee, getEmployee, updateEmployee} from '../services/EmployeeService'
                ...
                <form>
                    <div className='form-group mb-2'>
                        ...
                        <input
                            ...
                            // You use ${} in string templates like const k = `my name is ${name}` you 
                            // use {} whenever you want to put some Javas code in your 
                            // JSX code like <div attr={name}>{name}</div>
